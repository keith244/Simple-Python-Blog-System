...
# user1 = User(input('Whats your name? '))
# new_user = User('john')
# group1 = Group(user1)
# group1.create_group()
# print(group1)
# group1.show_groups()
# group1.delete_groups()
# # group1.create_group()
# manager = GroupManagement(group1)
# print(manager.add_member(new_user))
# print(manager.show_members_and_roles(user1))
# print(manager.remove_member())
# print(manager.show_members_and_roles(user1))
# add_user = GroupManagement(user1)
# print(add_user.add_member())
# group1 = add_user('john')
# print(group1.create_group())
# print(group1.add_member())
# print(group1)
# group1 = Group(user1,'Keith Group','my group')